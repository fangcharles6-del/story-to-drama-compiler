...
Generated operator reference for the exact offline deterministic catalog. This document grants no Provider, execution, rights, qualification, publication, training, or asset-promotion authority.

<!-- SDC-VISUAL-PROMPT-CATALOG-JSON:BEGIN -->
```json
{
  "catalog_projection": {
...
```
<!-- SDC-VISUAL-PROMPT-CATALOG-JSON:END -->
